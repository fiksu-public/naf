...
5. Now bring in all of the Naf schema migrations.  When you bundle the latest version of Naf for production, make sure to add this command to your deploy script. So that you can change to the Engine's latest schema.

    rake naf:install:migrations

6. This has copied all the Naf migrations to a new folder db/naf/migrate folder, run the schema changes.
